...
export default function Policy() {
     return (
          <div className="flex flex-col gap-8 overflow-y-auto px-3.5 lg:gap-16 lg:px-7">
               <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-0">
                    <h1 className="text-4xl font-bold -tracking-[0.23rem] lg:text-5xl">Политика конфиденциальности</h1>
                    <Link
                         href="/"
                         className="flex max-w-60 items-center justify-center gap-x-2.5 rounded-full border border-[#E6E6E6] p-4 lg:px-20 lg:py-4"
                    >
