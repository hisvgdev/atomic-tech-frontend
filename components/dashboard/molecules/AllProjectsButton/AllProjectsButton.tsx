...
export const AllProjectsButton: FC<AllProjectsButtonProps> = (props) => {
     ...
     return (
          <section data-dark="false">
               <MotionLink
                    href={link}
                    className="relative flex cursor-pointer items-center justify-center overflow-hidden rounded-4xl border-2 border-black py-9 transition-all lg:rounded-2xl lg:border lg:py-6"
               ...
               >
                    <span
                         className="text-2xl font-bold tracking-tight transition-colors lg:text-3xl"
