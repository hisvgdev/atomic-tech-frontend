...
export const customSolutionReview = z.object({
     ...
     rating: z
          .number({ message: 'Мы ожидаем что вы введете свою отметку!' })
          .max(5, 'Максимально допустима отметка - 5')
          .min(1, 'Минимальная допустимая отметка - 1'),
     review_text: z
          .string()
          .max(500, 'Вы превысили свой лимит отзыва в 500 символов!')
          .min(20, 'Необходимо минимум 20 символов'),
