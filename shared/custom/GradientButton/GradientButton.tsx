...
export const GradientButton: FC<GradientButtonProps> = (props) => {
     ...
     return (
          <MotionButton
               className={cn('relative flex cursor-pointer items-center overflow-hidden', classNames)}
               style={{
          ...
          >
               <motion.div
                    className={cn('pointer-events-none absolute inset-0 rounded-full', secondClassnames)}
